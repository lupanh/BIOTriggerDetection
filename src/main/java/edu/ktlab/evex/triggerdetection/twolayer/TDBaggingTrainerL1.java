...
public class TDBaggingTrainerL1 {
	...
	static String fileTraining = "model/" + corpusName + "2013/TriggerDetection.2L.L1." + corpusType;
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < numModels; i++) {
			createVectorTrainingFile(fileTraining + i, fileWordlist + i, sample_ratio);
			new Train().main(new String[] { "-c", "1.0", "-s", "6", fileTraining + i, fileModel + i });
		}
	}

	private static void createVectorTrainingFile(String fileTraining, String fileWordlist, double sample_ratio) throws Exception {
