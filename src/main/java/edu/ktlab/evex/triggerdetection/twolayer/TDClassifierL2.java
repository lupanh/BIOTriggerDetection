...
public class TDClassifierL2 implements Classifier {
	...
	String fileModel = "model/" + corpusName + "2013/TriggerDetection.training.2L.L2.model";
	String fileWordlist = "model/" + corpusName + "2013/TriggerDetection.training.2L.L2.wordlist";
	...
	public TDClassifierL2() throws Exception {
		init();
		loadModel();
		loadWordlist();
	}

	public TDClassifierL2(String model, String wordlist) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		TDClassifierL2 classifier = new TDClassifierL2();
